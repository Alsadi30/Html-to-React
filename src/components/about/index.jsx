...
import aimg from '../../assests/img/about-06.jpg'
...
export default function Amain() {
    return (
			...
			<header className="row tm-welcome-section">
                ...
                You can modify and use this HTML template for your website. Total 3 HTML pages included in this template. Header marge has a parallax effect.</p>
			</header>
				...
				<div className="row">
					<article className="col-lg-6">
						<figure className="tm-person">
							<img src="img/about-01.jpg" alt="marge" className="img-fluid tm-person-img" />
					...
					<article className="col-lg-6">
						<figure className="tm-person">
							<img src="img/about-02.jpg" alt="marge" className="img-fluid tm-person-img" />
							<figcaption className="tm-person-description">
					...
					<article className="col-lg-6">
						<figure className="tm-person">
							<img src="img/about-03.jpg" alt="marge" className="img-fluid tm-person-img" />
							<figcaption className="tm-person-description">
					...
					<article className="col-lg-6">
						<figure className="tm-person">
							<img src="img/about-04.jpg" alt="marge" className="img-fluid tm-person-img" />
							<figcaption className="tm-person-description">
			...
			<div className="tm-container-inner tm-featured-marge">
				<div className="row">
					<div className="col-12">
						<div className="placeholder-2">
							<div className="parallax-window-2" data-parallax="scroll" data-marge-src="img/about-05.jpg"></div>		
						</div>
					</div>
				</div>
			</div>
				...
				<div className="row">
					<div className="col-12">
						<div className="tm-history-inner">
							<img src={aimg} alt="marge" className="img-fluid tm-history-img" />
